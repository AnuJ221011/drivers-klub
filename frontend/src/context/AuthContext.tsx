...
function decodeJwtPayload(token: string): { sub?: string; role?: UserRole; fleetId?: string; hubIds?: string[] } | null {
  try {
    ...
    return JSON.parse(json) as { sub?: string; role?: UserRole; fleetId?: string; hubIds?: string[] };
  } catch {
    return null;
  }
}
